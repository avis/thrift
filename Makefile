...
ETAGS = etags
CTAGS = ctags
DIST_SUBDIRS = compiler/cpp lib test
...
ACLOCAL = ${SHELL} /home/avi/workspace/sipfish-newserver/thrift-0.9.0/missing --run aclocal-1.11
ALLOCA = 
AMTAR = $${TAR-tar}
ANT = 
ANT_FLAGS = 
AR = ar
AUTOCONF = ${SHELL} /home/avi/workspace/sipfish-newserver/thrift-0.9.0/missing --run autoconf
AUTOHEADER = ${SHELL} /home/avi/workspace/sipfish-newserver/thrift-0.9.0/missing --run autoheader
AUTOMAKE = ${SHELL} /home/avi/workspace/sipfish-newserver/thrift-0.9.0/missing --run automake-1.11
AWK = gawk
...
CXXCPP = /opt/centos/devtoolset-1.1/root/usr/bin/c++ -E
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/avi/workspace/sipfish-newserver/thrift-0.9.0/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
MONO_CFLAGS = 
MONO_LIBS = 
NM = /usr/bin/nm -B
...
ZLIB_LDFLAGS = 
ZLIB_LIBS = -lz
abs_builddir = /home/avi/workspace/sipfish-newserver/thrift-0.9.0
abs_srcdir = /home/avi/workspace/sipfish-newserver/thrift-0.9.0
abs_top_builddir = /home/avi/workspace/sipfish-newserver/thrift-0.9.0
abs_top_srcdir = /home/avi/workspace/sipfish-newserver/thrift-0.9.0
...
install_sh = ${SHELL} /home/avi/workspace/sipfish-newserver/thrift-0.9.0/install-sh
...
SUBDIRS = compiler/cpp lib $(am__append_1)
EXTRA_DIST = \
 			doc \
			tutorial \
			contrib \
